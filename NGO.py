...
class parent(GridLayout, Label):
    ...
    def set_time(self):
        self.time=int(input("Enter the time by which NGO can pick ip the food:"))
        print("Food will picked up by ",self.time )
class NGO(App, GridLayout):
    def build(self):
        return parent()
...
message=client.messages.create(
    body="There is need of food to feed the hungry..., please inform us if food left!!!",
    from_=phone_no,
    to="+919060768193"
)
print("Request message has been sent successfully:")
